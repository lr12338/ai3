...
这套目录按 `2025-AI-Trainer-practices/practices/1.1.1_题名` 的方式重组，便于逐题练习。

## 使用方式

- 先从 `1.1.1 / 2.1.1 / 2.2.1 / 3.1.1 / 3.2.1 / 4.2.1` 六道代表题入手。
- 每题目录优先看 `README.md`，再打开 `exam_preview.html` 和主练习文件。
- 有数据或模型资源的题目统一放到 `data/` 目录。
